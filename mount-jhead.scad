	...
	union() {
		difference() {
			...
			union() {//removal section
				...
				translate([0,e_vert_offset+e_height,b_thickness/2])
					cube([b_width-m3_diameter*9-h_offset*2,e_height,b_thickness+0.2],center=true);
				translate([b_width/2-m3_diameter/2,e_vert_offset+e_height,b_thickness/2])
					cube([m3_diameter+0.1,e_height,b_thickness+0.2],center=true);
				translate([-b_width/2+m3_diameter/2,e_vert_offset+e_height,b_thickness/2])
					cube([m3_diameter+0.1,e_height,b_thickness+0.2],center=true);
